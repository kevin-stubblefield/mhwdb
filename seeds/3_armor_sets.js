  ...
  return knex('armor_sets').del()
    .then(function () {
      ...
      return knex('armor_sets').insert([
        ...
        { name: 'Anja', description: 'Modeled after an unknown tribe\'s hunting garb, the Anja armor\'s design is a symbol of bravery.', rank: 0, head: 80, chest: 81, hands: 82, waist: 83, legs: 84, set_bonus_name: 'Anjanath Power', set_bonus_1_id: 111, set_bonus_1_count: 3 },
        ...
        { name: 'Legiana', description: 'Armor worn by proven masters of the wind. Made of Legiana parts, it glistens a piercing blue.', rank: 0, head: 120, chest: 121, hands: 122, waist: 123, legs: 124, set_bonus_name: 'Legiana Blessing', set_bonus_1_id: 123, set_bonus_1_count: 3 },
        { name: 'Odogaron', description: 'None who lay eyes upon this Odogaron armor are seen again, as it erodes the wearer\'s sanity.', rank: 0, head: 125, chest: 126, hands: 127, waist: 128, legs: 129, set_bonus_name: 'Odogaron Power', set_bonus_1_id: 125, set_bonus_1_count: 3 },
        { name: 'Rathalos', description: 'Crafted from parts carved from the King of the Skies, this crimson armor boasts overwhelming defense.', rank: 0, head: 130, chest: 131, hands: 132, waist: 133, legs: 134, set_bonus_name: 'Rathalos Power', set_bonus_1_id: 113, set_bonus_1_count: 3 },
        { name: 'Diablos', description: 'The bold horns on this Diablos armor are a challenge to any who doubt your rule over the sands.', rank: 0, head: 135, chest: 136, hands: 137, waist: 138, legs: 139, set_bonus_name: 'Diablos Power', set_bonus_1_id: 115, set_bonus_1_count: 3 },
        { name: 'Kirin', description: 'Don this gorgeous Kirin armor and canter through the wilderness living out your wildest equine fantasies.', rank: 0, head: 140, chest: 141, hands: 142, waist: 143, legs: 144, set_bonus_name: 'Kirin Blessing', set_bonus_1_id: 127, set_bonus_1_count: 4 },
        ...
        { name: 'Anja α', description: 'Modeled after an unknown tribe\'s hunting garb, the Anja armor\'s design is a symbol of bravery.', rank: 1, head: 292, chest: 293, hands: 294, waist: 295, legs: 296, set_bonus_name: 'Anjanath Will', set_bonus_1_id: 111, set_bonus_1_count: 2, set_bonus_2_id: 112, set_bonus_2_count: 4 },
        { name: 'Anja ß', description: 'Modeled after an unknown tribe\'s hunting garb, the Anja armor\'s design is a symbol of bravery.', rank: 1, head: 297, chest: 298, hands: 299, waist: 300, legs: 301, set_bonus_name: 'Anjanath Will', set_bonus_1_id: 111, set_bonus_1_count: 2, set_bonus_2_id: 112, set_bonus_2_count: 4 },
        ...
        { name: 'Rath Heart α', description: 'Rathian armor that exhibits such a regal presence that it leaves all who see it captivated and awed.', rank: 1, head: 342, chest: 343, hands: 344, waist: 345, legs: 346, set_bonus_name: 'Pink Rathian Mastery', set_bonus_1_id: 110, set_bonus_1_count: 3 },
        { name: 'Rath Heart ß', description: 'Rathian armor that exhibits such a regal presence that it leaves all who see it captivated and awed.', rank: 1, head: 347, chest: 348, hands: 349, waist: 350, legs: 351, set_bonus_name: 'Pink Rathian Mastery', set_bonus_1_id: 110, set_bonus_1_count: 3 },
        ...
        { name: 'Zorah α', description: 'Stalwart as a mountain, this Zorah Magdaros armor renders its wearer unfazed by any hardship.', rank: 1, head: 376, chest: 377, hands: 378, waist: 379, legs: 380, set_bonus_name: 'Zorah Magdaros Mastery', set_bonus_1_id: 122, set_bonus_1_count: 3 },
        { name: 'Zorah ß', description: 'Stalwart as a mountain, this Zorah Magdaros armor renders its wearer unfazed by any hardship.', rank: 1, head: 381, chest: 382, hands: 383, waist: 384, legs: 385, set_bonus_name: 'Zorah Magdaros Mastery', set_bonus_1_id: 122, set_bonus_1_count: 3 },
        ...
        { name: 'Legiana α', description: 'Armor worn by proven masters of the wind. Made of Legiana parts, it glistens a piercing blue.', rank: 1, head: 418, chest: 419, hands: 420, waist: 421, legs: 422, set_bonus_name: 'Legiana Favor', set_bonus_1_id: 123, set_bonus_1_count: 2, set_bonus_2_id: 124, set_bonus_2_count: 4 },
        { name: 'Legiana ß', description: 'Armor worn by proven masters of the wind. Made of Legiana parts, it glistens a piercing blue.', rank: 1, head: 423, chest: 424, hands: 425, waist: 426, legs: 427, set_bonus_name: 'Legiana Favor', set_bonus_1_id: 123, set_bonus_1_count: 2, set_bonus_2_id: 124, set_bonus_2_count: 4 },

        { name: 'Odogaron α', description: 'None who lay eyes upon this Odogaron armor are seen again, as it erodes the wearer\'s sanity.', rank: 1, head: 428, chest: 429, hands: 430, waist: 431, legs: 432, set_bonus_name: 'Odogaron Mastery', set_bonus_1_id: 125, set_bonus_1_count: 2, set_bonus_2_id: 126, set_bonus_2_count: 4 },
        { name: 'Odogaron ß', description: 'None who lay eyes upon this Odogaron armor are seen again, as it erodes the wearer\'s sanity.', rank: 1, head: 433, chest: 434, hands: 435, waist: 436, legs: 437, set_bonus_name: 'Odogaron Mastery', set_bonus_1_id: 125, set_bonus_1_count: 2, set_bonus_2_id: 126, set_bonus_2_count: 4 },
        
        { name: 'Rathalos α', description: 'Crafted from parts carved from the King of the Skies, this crimson armor boasts overwhelming defense.', rank: 1, head: 438, chest: 439, hands: 440, waist: 441, legs: 442, set_bonus_name: 'Rathalos Mastery', set_bonus_1_id: 113, set_bonus_1_count: 2, set_bonus_2_id: 114, set_bonus_2_count: 4 },
        { name: 'Rathalos ß', description: 'Crafted from parts carved from the King of the Skies, this crimson armor boasts overwhelming defense.', rank: 1, head: 443, chest: 444, hands: 445, waist: 446, legs: 447, set_bonus_name: 'Rathalos Mastery', set_bonus_1_id: 113, set_bonus_1_count: 2, set_bonus_2_id: 114, set_bonus_2_count: 4 },

        { name: 'Rath Soul α', description: 'Azure armor imbued with absolute power. Those who wear it are destined to make history.', rank: 1, head: 448, chest: 449, hands: 450, waist: 451, legs: 452, set_bonus_name: 'Rathalos Mastery', set_bonus_1_id: 113, set_bonus_1_count: 2, set_bonus_2_id: 114, set_bonus_2_count: 4 },
        { name: 'Rath Soul ß', description: 'Azure armor imbued with absolute power. Those who wear it are destined to make history.', rank: 1, head: 453, chest: 454, hands: 455, waist: 456, legs: 457, set_bonus_name: 'Rathalos Mastery', set_bonus_1_id: 113, set_bonus_1_count: 2, set_bonus_2_id: 114, set_bonus_2_count: 4 },

        { name: 'Diablos α', description: 'The bold horns on this Diablos armor are a challenge to any who doubt your rule over the sands.', rank: 1, head: 458, chest: 459, hands: 460, waist: 461, legs: 462, set_bonus_name: 'Diablos Mastery', set_bonus_1_id: 115, set_bonus_1_count: 2, set_bonus_2_id: 116, set_bonus_2_count: 4 },
        { name: 'Diablos ß', description: 'The bold horns on this Diablos armor are a challenge to any who doubt your rule over the sands.', rank: 1, head: 463, chest: 464, hands: 465, waist: 466, legs: 467, set_bonus_name: 'Diablos Mastery', set_bonus_1_id: 115, set_bonus_1_count: 2, set_bonus_2_id: 116, set_bonus_2_count: 4 },

        { name: 'Uragaan α', description: 'Heavy armor made of heavy Uragaan parts, and every ounce of it adds to its defense.', rank: 1, head: 468, chest: 469, hands: 470, waist: 471, legs: 472, set_bonus_name: 'Uragaan Protection', set_bonus_1_id: 117, set_bonus_1_count: 3 },
        { name: 'Uragaan ß', description: 'Heavy armor made of heavy Uragaan parts, and every ounce of it adds to its defense.', rank: 1, head: 473, chest: 474, hands: 475, waist: 476, legs: 477, set_bonus_name: 'Uragaan Protection', set_bonus_1_id: 117, set_bonus_1_count: 3 },

        { name: 'Bazel α', description: 'The earth quivers beneath each step taken in this Bazelgeuse armor. Behind you, a scorched path.', rank: 1, head: 478, chest: 479, hands: 480, waist: 481, legs: 482, set_bonus_name: 'Bazelgeuse Protection', set_bonus_1_id: 118, set_bonus_1_count: 3 },
        { name: 'Bazel ß', description: 'The earth quivers beneath each step taken in this Bazelgeuse armor. Behind you, a scorched path.', rank: 1, head: 483, chest: 484, hands: 485, waist: 486, legs: 487, set_bonus_name: 'Bazelgeuse Protection', set_bonus_1_id: 118, set_bonus_1_count: 3 },
        ...
        { name: 'Nergigante α', description: 'This Nergigante armor is said to feed on a hunter\'s spirit in exchange for its brutal power.', rank: 1, head: 519, chest: 520, hands: 521, waist: 522, legs: 523, set_bonus_name: 'Nergigante Hunger', set_bonus_1_id: 108, set_bonus_1_count: 3 },
        { name: 'Nergigante ß', description: 'This Nergigante armor is said to feed on a hunter\'s spirit in exchange for its brutal power.', rank: 1, head: 524, chest: 525, hands: 526, waist: 527, legs: 528, set_bonus_name: 'Nergigante Hunger', set_bonus_1_id: 108, set_bonus_1_count: 3 },

        { name: 'Teostra α', description: 'Forged from parts carved from a Teostra, this armor is host to the Flame King Dragon\'s soul.', rank: 1, head: 529, chest: 530, hands: 531, waist: 532, legs: 533, set_bonus_name: 'Teostra Technique', set_bonus_1_id: 119, set_bonus_1_count: 3 },
        { name: 'Teostra ß', description: 'Forged from parts carved from a Teostra, this armor is host to the Flame King Dragon\'s soul.', rank: 1, head: 534, chest: 535, hands: 536, waist: 537, legs: 538, set_bonus_name: 'Teostra Technique', set_bonus_1_id: 119, set_bonus_1_count: 3 },

        { name: 'Kushala α', description: 'Armor made from Kushala Daora parts. It resembles the statue of an ancient deity come to life.', rank: 1, head: 539, chest: 540, hands: 541, waist: 542, legs: 543, set_bonus_name: 'Kushala Daora Flight', set_bonus_1_id: 120, set_bonus_1_count: 3 },
        { name: 'Kushala ß', description: 'Armor made from Kushala Daora parts. It resembles the statue of an ancient deity come to life.', rank: 1, head: 544, chest: 545, hands: 546, waist: 547, legs: 548, set_bonus_name: 'Kushala Daora Flight', set_bonus_1_id: 120, set_bonus_1_count: 3 },

        { name: 'Vaal Hazak α', description: 'Whispers haunt this Vaal Hazak armor, urging any who don it to embrace despair, and consume...', rank: 1, head: 549, chest: 550, hands: 551, waist: 552, legs: 553, set_bonus_name: 'Vaal Hazak Vitality', set_bonus_1_id: 109, set_bonus_1_count: 3 },
        { name: 'Vaal Hazak ß', description: 'Whispers haunt this Vaal Hazak armor, urging any who don it to embrace despair, and consume...', rank: 1, head: 554, chest: 555, hands: 556, waist: 557, legs: 558, set_bonus_name: 'Vaal Hazak Vitality', set_bonus_1_id: 109, set_bonus_1_count: 3 },

        { name: 'Xeno\'jiiva α', description: 'This Xeno\'jiiva armor hums with energy. If properly controlled, it grants the wearer vast power.', rank: 1, head: 559, chest: 560, hands: 561, waist: 562, legs: 563, set_bonus_name: 'Xeno\'jiiva Divinity', set_bonus_1_id: 121, set_bonus_1_count: 3 },
